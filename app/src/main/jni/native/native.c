...
jstring Java_me_darkeet_android_jni_NativeMethod_sayHi
...
//处理整形相加
JNIEXPORT jint JNICALL Java_me_darkeet_android_jni_NativeMethod_add
...
//处理数组中的每一个元素
JNIEXPORT jintArray JNICALL Java_me_darkeet_android_jni_NativeMethod_intMethod
...
// 调用java中的静态方法print
JNIEXPORT void JNICALL Java_me_darkeet_android_jni_NativeMethod_callPrint
	(JNIEnv *env, jobject obj) {

	char* classname = "me/darkeet/android/jni/NativeMethod";
...
JNIEXPORT void JNICALL Java_me_darkeet_android_jni_NativeMethod_callMethod
	(JNIEnv *env, jobject obj) {
	// 注意和上面的静态方法区别
	char* classname = "me/darkeet/android/jni/NativeMethod";
	jclass dpclazz = (*env)->FindClass(env,classname);
